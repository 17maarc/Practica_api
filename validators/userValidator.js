...
const validateRegister = [
    ...
    body('age').isNumeric().withMessage('La edad debe ser un número'), // Verifica que la edad sea numérica
...
module.exports = { validatorLogin, validateRegister, validateUpdate, validateDelete }; // Exporta los validadores